...
int main() {
    ...
    const int numSamples = 10000; // Higher resolution for accurate results
    ...
    if (peaks.size() < 2) {
        ...
        return 0; // Not enough peaks to form a valley
    }

    // Find the widest valley between consecutive peaks
